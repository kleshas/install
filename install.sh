...
#install i3 and/or sway	
	...
	if [ "$REPLY" = "y" ]; then
		yay -S sway otf-font-awesome waybar clipman lxappearance wofi xorg-xwayland xorg-xlsclients qt5-wayland glfw-wayland wl-clipboard gammastep swaylock-blur-bin vlc
	fi

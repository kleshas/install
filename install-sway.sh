#!/bin/bash
  ...
  yay -S way kitty waybar wofi xorg-xwayland xorg-xlsclients qt5-wayland glfw-wayland wl-clipboard otf-font-awesome gammastep-indicator swaylock-blur-bin kitty feh
